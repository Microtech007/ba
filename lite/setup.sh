...
echo '============================================='
wget https://raw.githubusercontent.com/Microtech007/ba/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo '============================================='
echo '============================================='
echo '        Installing V2RAY '
echo '============================================='
wget https://raw.githubusercontent.com/Microtech007/ba/main/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
echo '============================================='
echo '        Installing XRAY '
echo '============================================='
wget https://raw.githubusercontent.com/Microtech007/ba/main/install-xray.sh && chmod +x install-xray.sh && screen -S v2ray ./install-xray.sh
echo '============================================='
echo '        Installing Websocket '
echo '============================================='
wget https://raw.githubusercontent.com/Microtech007/ba/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh

mkdir /root/.ctech
curl https://raw.githubusercontent.com/syfqsamvpn/digi/main/banner >/root/.ctech/banner
echo "MTS" >/root/.ctech/name
...
echo ""
echo "------------------Script Created By MTS---------------------" | tee -a log-install.txt
